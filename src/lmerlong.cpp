...
//' @export
// [[Rcpp::export]]
List lmerlong(arma::mat x, arma::mat z, arma::vec y, double m, arma::vec block,
  ...
  for (int i = 0; i < samples(0); i++) {
    ...
    if (delt > 0) {
      ...
      gamm(r) = psiv;
      gamm = varmsamp(y, x, z, m, beta, mb, Rb, gamm, vm, vs, phivprior, psivprior);
